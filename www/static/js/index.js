...
var _objectFitImages = __webpack_require__(12);

var _objectFitImages2 = _interopRequireDefault(_objectFitImages);

var _fancybox = __webpack_require__(13);
...
var Common = exports.Common = function () {
  ...
  _createClass(Common, null, [{
    ...
    value: function init() {
      ...
      (0, _initContactMap.initContactMap)();
    }
  }]);
  ...
  _createClass(CTabs, [{
    ...
    value: function bindEvents() {
      ...
      if (!this.$tabNav.hasClass('js-disabled') && this.getActiveIndex() !== 0) {
        this.$tabItem.hide().eq(this.getActiveIndex()).show().css('display', 'flex');
      }
...
function showReasons() {
  var $moreBtn = $('.js-more-reason');

  if (!$moreBtn.length) return;

  $moreBtn.on('click', function (e) {
    var _this = $(this);
    var $btnWrapper = _this.parent();
    var speed = 0.3;

    e.preventDefault();
    $btnWrapper.nextAll().slideDown().css('display', 'inline-block');
    _gsap.TweenMax.to($btnWrapper, 0.5, { height: '0', autoAlpha: 0 });
    _gsap.TweenMax.staggerFromTo($btnWrapper.nextAll(), speed, {
      autoAlpha: 0,
      y: -50
    }, {
      autoAlpha: 1,
...
function initSliders() {
  ...
  var $employeesSld = $('.js-default-slider');
...
exports.initContactMap = initContactMap;

var _helpers = __webpack_require__(0);

function initContactMap() {

  var $mapBlock = $('.contact-map');
  ...
  function init() {
    ...
    var street2 = new ymaps.Placemark([53.206337071231616, 50.23361099999988], {
    ...
    var street3 = new ymaps.Placemark([53.218637071205436, 50.2605155], {
    ...
    var street4 = new ymaps.Placemark([53.22939807117525, 50.20904200000001], {
    ...
    var street5 = new ymaps.Placemark([53.21202157121727, 50.157155499999945], {
    ...
    streets.add(street1).add(street2).add(street3).add(street4).add(street5);
    ...
    var $streetsList = $('.js-contact-streets');
    var $streetLink = $streetsList.find('a');

    $streetLink.on('click', function (e) {
      e.preventDefault();
      var $that = $(this);
      var $streetLinkCoord = $that.data('str-coords');
      var $parent = $that.parent();

      contactMap.panTo($streetLinkCoord, {
        duration: 1000
      });
      $parent.siblings().removeClass(_helpers.css.active);
      $parent.addClass(_helpers.css.active);
    });
  }
}
...
var PublicAPI = exports.PublicAPI = function () {
  ...
  _createClass(PublicAPI, null, [{
    ...
    get: function get() {
      return {
        init: _Timer2.default.startTimer,
        stop: _Timer2.default.stopTimer
      };
    }
  }]);
