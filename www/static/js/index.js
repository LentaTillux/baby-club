...
var _initContactBlock = __webpack_require__(24);
  ...
  function init() {
    var contactMapMoscow = new ymaps.Map('contact-map-moscow', {
      ...
      controls: []
        ...
        MyIconContentLayout = ymaps.templateLayoutFactory.createClass('<div class="contact__map-icon">\n             <img src="static/img/icons/map-icon.svg"/>\n        </div>'),
    ...
    for (var _i = 0, _l = blueCoords.length; _i < _l; _i++) {
      blueCollection.add(new ymaps.Placemark(blueCoords[_i]));
    }
